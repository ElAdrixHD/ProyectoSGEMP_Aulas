    ...
    <div class="container">
        <div id="editar-row" class="row justify-content-center align-items-center">
            <div id="editar-column" class="col-md-6">
                ...
                ?>
                    <h1 class="text-center text-white">EDITAR PERFIL</h1>
                    <form id="editar-form" action="editar_perfil.php" class="form" method="post">
                        <div class="form-group">
                            <label for="username" class="text-white">Nombre de usuario:</label><br>
                        ...
                        <div class="form-group">
                            <label for="correo" class="text-white">Correo electronico:</label><br>
                        ...
                        <div class="form-group">
                            <label for="apellidos" class="text-white">Apellidos:</label><br>
                        ...
                        <div class="form-group">
                            <label for="password" class="control-label text-white">Cambio de contraseña:</label>
                        ...
                        <div class="form-group">
                            <label for="fnac" class="text-white">Fecha Nacimiento:</label><br>
                        ...
                        <div id="back-link" class="text-right form-group">
                            <a href="panel.php" class="btn btn-danger">Cancelar</a>
                        </div>
                    </form>
            </div>
        </div>
